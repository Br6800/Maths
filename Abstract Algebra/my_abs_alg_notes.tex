...
\end{proof}
\end{lemma}
This theory is something you can use when coding. Rotation of an $n \times n$ matrix by 90 degrees is a permutation on the elements in the matrix. For a five by fivem there are 7 distinct orbits illustrated by different colours:
...
$$ 
Each cycle is then a product of transpositions, e.g. $(1,5,25,21) = (21,25)(25,5)(5,1)$. A transposition $(a,b)$ can be done in place with xor via $a \to a \oplus b$ then $b \to a \oplus b = ( a \oplus b) \oplus b = a \oplus (b \oplus b) = a \oplus 0 = a$ then $a -> b \oplus a = a \oplus (a \oplus b) = b$.
\begin{lemma}
